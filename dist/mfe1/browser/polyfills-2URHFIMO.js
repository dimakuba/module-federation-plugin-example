  ...
  function parse(l2, k2 = "@") {
    ...
    if (u2 > i || !e) {
      ...
      a = new ArrayBuffer(i), s(t, new Uint16Array(a, 16, 105)), e = function(e2, a2, r2) {
        ;
        var i2 = new e2.Int8Array(r2), s2 = new e2.Int16Array(r2), t2 = new e2.Int32Array(r2), c2 = new e2.Uint8Array(r2), f2 = new e2.Uint16Array(r2), n2 = 1024;
        function b2() {
          var e3 = 0, a3 = 0, r3 = 0, c3 = 0, b3 = 0, u4 = 0, w3 = 0;
          w3 = n2;
          n2 = n2 + 10240 | 0;
          i2[795] = 1;
          s2[395] = 0;
                ...
                do {
                  switch (s2[r3 >> 1] | 0) {
                    ...
                    case 32:
                      break;
                    case 101: {
                      if ((((s2[396] | 0) == 0 ? H(r3) | 0 : 0) ? (m(e3 + 4 | 0, 16, 10) | 0) == 0 : 0) ? (l3(), (i2[795] | 0) == 0) : 0) {
                        b3 = 9;
                        break e;
                      } else
                        b3 = 17;
                    ...
                    do {
                      switch (s2[a3 >> 1] | 0) {
                        ...
                        case 41: {
                          ...
                          s2[396] = a3;
                          r3 = s2[395] | 0;
                          if (r3 << 16 >> 16 != 0 ? (u4 = t2[(t2[69] | 0) + ((r3 & 65535) + -1 << 2) >> 2] | 0, (t2[u4 + 20 >> 2] | 0) == (t2[(t2[68] | 0) + ((a3 & 65535) << 3) + 4 >> 2] | 0)) : 0) {
                            a3 = u4 + 4 | 0;
                            if (!(t2[a3 >> 2] | 0))
                              t2[a3 >> 2] = c3;
                            t2[u4 + 12 >> 2] = e3 + 4;
                              ...
                              r:
                                do {
                                  if (!(U(c3) | 0)) {
                                    switch (c3 << 16 >> 16) {
                                      case 41:
                                        if (D(t2[(t2[68] | 0) + (f2[396] << 3) + 4 >> 2] | 0) | 0) {
                                          b3 = 69;
                                          break r;
                                        } else {
                                          b3 = 66;
        ...
        function l3() {
          var e3 = 0, a3 = 0, r3 = 0, c3 = 0, f3 = 0, n3 = 0, b3 = 0, l4 = 0, k4 = 0, o3 = 0, h3 = 0, A2 = 0, C2 = 0, g2 = 0;
          l4 = t2[70] | 0;
          k4 = t2[63] | 0;
          g2 = l4 + 12 | 0;
          t2[70] = g2;
                        ...
                        switch (r3 << 16 >> 16) {
                          case 100: {
                            ...
                            switch ((w2(1) | 0) << 16 >> 16) {
                              case 97: {
                                a3 = t2[70] | 0;
                                if ((m(a3 + 2 | 0, 56, 8) | 0) == 0 ? (f3 = a3 + 10 | 0, F(s2[f3 >> 1] | 0) | 0) : 0) {
                                  t2[70] = f3;
                                  w2(0) | 0;
                                  C2 = 22;
                                }
                              ...
                              case 99: {
                                a3 = t2[70] | 0;
                                if (((m(a3 + 2 | 0, 36, 8) | 0) == 0 ? (c3 = a3 + 10 | 0, g2 = s2[c3 >> 1] | 0, V(g2) | 0 | g2 << 16 >> 16 == 123) : 0) ? (t2[70] = c3, n3 = w2(1) | 0, n3 << 16 >> 16 != 123) : 0) {
                                  A2 = n3;
                                  C2 = 31;
                                }
                                break;
                            ...
                            if ((C2 | 0) == 31 ? (o3 = t2[70] | 0, q(A2) | 0, h3 = t2[70] | 0, h3 >>> 0 > o3 >>> 0) : 0) {
                              $(e3, l4, o3, h3);
                              t2[70] = (t2[70] | 0) + -2;
                              break e;
                            }
        ...
        function D(e3) {
          e3 = e3 | 0;
          if (!(O(e3, 180, 5) | 0) ? !(O(e3, 190, 3) | 0) : 0)
            e3 = O(e3, 196, 2) | 0;
          else
            e3 = 1;
          return e3 | 0;
        ...
        return { su: te, ai: M, e: se, ee: Y, ele: J, els: L, es: ee, f: ie, id: z, ie: N, ip: ae, is: _, p: b2, re: R, ri: Q, sa: S, se: K, ses: re, ss: X };
    ...
    switch (++n, e2) {
      ...
      case 117:
        return function() {
          const e3 = c$1.charCodeAt(n);
          let a2;
          123 === e3 ? (++n, a2 = k(c$1.indexOf("}", n) - n), ++n, a2 > 1114111 && o()) : a2 = k(4);
